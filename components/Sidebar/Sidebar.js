...
function Sidebar() {
  ...
  if (isSmallScreen) {
    return (
      <div className="fixed bottom-0 w-[100vw] leading-0 items-center h-[13vh] bg-[#080826] text-white flex justify-around">
        <Link href="/">
          <div className={`transition-all duration-500 h-[13vh] hover:text-[#080826] hover:bg-[#bae5f4] w-[20vw] flex flex-col items-center justify-center   ${router.pathname === '/' ? 'bg-gray-900' : ''}`}>
            <RiHomeFill size={35} />

          </div>
        </Link>
        <Link href="#second">
          <div className={`transition-all duration-500 h-[13vh] hover:text-[#080826] hover:bg-[#bae5f4] w-[20vw] flex flex-col items-center justify-center   ${router.pathname === '/second' ? 'bg-gray-900' : ''}`}>
            <AiOutlineInfoCircle size={35} />

          </div>
        </Link>
        <Link href="#third">
          <div className={`transition-all duration-500 h-[13vh] hover:text-[#080826] hover:bg-[#bae5f4] w-[20vw] flex flex-col items-center justify-center  ${router.pathname === '/third' ? 'bg-gray-900' : ''}`}>
            <FaPhone size={25} />

          </div>
        </Link>
        <Link href="#fourth">
          <div className={`transition-all duration-500 h-[13vh] hover:text-[#080826] hover:bg-[#bae5f4] w-[20vw] flex flex-col items-center justify-center  ${router.pathname === '/fourth' ? 'bg-gray-900' : ''}`}>
            <FaList size={30} />
    ...
    return (
      ...
      >
        <div className='flex flex-col items-start h-full space-y-4 py-[2vh]'>
